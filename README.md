...
##  Workflow
1. Collected and explored COVID-19 dataset
2. Cleaned data in Power BI
3. Built interactive visuals and filters
4. Designed dashboard to highlight key trends
